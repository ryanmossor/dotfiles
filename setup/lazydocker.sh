...
case "$os" in
    mac)
        ! have lazydocker && brew install jesseduffield/lazydocker/lazydocker ;;
    omarchy)
        ! have lazydocker && omarchy-pkg-add lazydocker ;;
    ubuntu)
        ...
        ;;
    *)
        echo "OS not supported. Skipping lazydocker installation." ;;
esac
